...
def ogrenci_ekleme_sayfasi(root_frame):
    ...
    def kaydet():
        ...
        ogrenci_foto = ogrenci_foto_entry.get().strip()
        ...
        # Validasyon
        if not all([ogrenci_adi, ogrenci_soyadi, ogrenci_foto, ogrenci_adres, ogrenci_tel, ogrenci_tckn, ogrenci_numara, sifre]):
