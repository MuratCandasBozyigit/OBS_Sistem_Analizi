...
def ogrenci_ekleme_sayfasi(root_frame):
    ...
    def kaydet():
        ...
        # Vize ve Final bu formdan girilmeyecek, o yüzden None olarak ayarlanıyor
        vize = None
        final = None
        ...
        if ogrenci_adi and ogrenci_soyadi and ogrenci_foto and ogrenci_adres and ogrenci_tel and ogrenci_tckn and ogrenci_numara and sifre:
            ogrenci_ekle(ogrenci_adi, ogrenci_soyadi, ogrenci_foto, ogrenci_adres, ogrenci_tel, ogrenci_tckn, ogrenci_numara, vize, final,sifre)
